...
//			int randomInt = (int) (Math.random() * 42); // 최초 랜덤 값 생성 실제 개수 보다 -1(0부터 시작)
			...
			String[] portfolioContent = { "b3cad878-6a36-4636-b2f5-23f3535675bf",
					...
					"<div class=\"se-component se-image-container __se__float-center\">\r\n" + "    <figure>\r\n"
							...
							+ "            <img src=\"/static/boardImgs/portfolioImgs/03340b04-dba4-4903-a541-8406d6b2fa87_sesil2.jpg\"\r\n"
			...
			String[] descriptionArr = {
					...
					"Best Eleven이라는 유명 축구 잡지를 배경으로 구성", "기존 브랜드 이미지에 걸맞게 제작", "가방이 움직이고 통통 튐으로서 활기 있는 분위기 조성",
					"기존 브랜드 이미지에 걸맞게 제작", "기존 브랜드 이미지에 걸맞게 제작", "필수 사항 입력 후 체크항목을 선택하여 제출하여 excel 파일을 생성",
					"JSP를 사용하여 여러개의 input에 데이터를 담아 버튼을 누르면 해당 페이지를 캡쳐하여 이메일로 전송하는 폼형식",
					"썸네일 이미지를 클릭하면 포트폴리오 이미지를 돋보이게 제작" };

			Category[] categoryArr = { Category.홈페이지, Category.브로셔, Category.로고, Category.로고, Category.로고, Category.포스터,
					Category.포스터, Category.포스터, Category.포스터, Category.포스터, Category.기타, Category.포스터, Category.홈페이지,
					Category.홈페이지, Category.홈페이지, Category.홈페이지, Category.홈페이지, Category.홈페이지, Category.홈페이지,
					Category.캐릭터, Category.캐릭터, Category.캐릭터, Category.상세페이지, Category.상세페이지, Category.상세페이지,
					Category.상세페이지, Category.상세페이지, Category.상세페이지, Category.상세페이지, Category.상세페이지, Category.상세페이지,
					Category.상세페이지, Category.상세페이지, Category.상세페이지, Category.잡지, Category.잡지, Category.기타, Category.기타,
			...
			String[][] tagStrArr = { { "포트폴리오", "블로그", "웹개발" }, { "김치", "삽화", "아트워크" }, { "쿠쿠", "B.I", "C.I" },
					...
					{ "축제", "삽화" }, { "대한민국", "삽화", "캘리그라피" }, { "3D", "대한민국" }, { "다이어리", "삽화" }, { "세균", "햄버거" },
					{ "그누보드", "파워링크", "SEO" }, { "그누보드", "견적문의" }, { "가방브랜드", "쇼핑몰", "메이크샵" }, { "가방브랜드", "쇼핑몰" },
					{ "웹표준", "포트폴리오" }, { "과제", "디자인역사" }, { "미술관", "다이나믹" }, { "캐리커처", "삽화" }, { "캐리커처", "삽화" },
					{ "삽화", "우주", "오징어" }, { "싱가폴", "퍼플", "핑크" }, { "스키", "고글" }, { "가방브랜드", "쇼핑몰" },
					{ "쇼핑몰", "주방기기", "오픈마켓" }, { "쇼핑몰", "다리미판", "오픈마켓" }, { "쇼핑몰", "볼바구니", "오픈마켓" },
					{ "쇼핑몰", "오픈마켓", "가방브랜드" }, { "쇼핑몰", "건조대", "오픈마켓" }, { "스키", "블루", "화이트" }, { "일식집", "메뉴판" },
					{ "쇼핑몰", "스마트백", "오픈마켓" }, { "가방브랜드", "사은품" }, { "Nature", "무궁화" }, { "BestEleven", "축구" },
					{ "가방브랜드", "정품" }, { "GIF", "배너", "가방브랜드" }, { "가방브랜드", "배너" }, { "가방브랜드", "신상품" },
			...
			String[] uuid = { "b3cad878-6a36-4636-b2f5-23f3535675bf", "e09042b7-9afe-43d5-9639-f450e08b550d",
					...
					"01d46bc7-30a7-48be-86b8-e854dfd685bf", "2e64783c-7dd0-4990-b10a-a7262b253494",
					"0035d7c4-1d4a-4de9-9eaa-0abddb28aecc", "45e766c3-6362-4a88-921b-1128c70be36a",
					"29e1c494-b51e-4af7-b830-ffeeab668e59" };
			WorkImage workImage = WorkImage.builder().path("static/boardImgs/thumbnails").uuid(uuid[i])
					.workBoard(work).imgName("img" + (i + 1) + ".jpg").build();
